...
class companyEdit extends Component {
  constructor(props) {
    ...
    if (this.props.location.state != undefined) {
      const { companyUpdate } = this.props.location.state;
      this.state = {
        isCheckedCompanyEdit: false,
        companyName: companyUpdate.companyName,
        companyStatusName: companyUpdate.companyStatusName,
        taxCircle: companyUpdate.taxCircle,
        taxNumber: companyUpdate.taxNumber,
        companyEmail: companyUpdate.companyEmail,
        companyPhoneNo: companyUpdate.companyPhoneNo,
        companyAdress: companyUpdate.companyAdress,
  ...
  onSubmit(e){
    ...
    if (this.handleValidation()) {
      ...
      axios.put("company/companyupdate", updateCompany).then((response) => {
  ...
  handleValidation() {
    ...
    if (
      ...
      formIsValid = false;
      toast.warn("Telefon Numarası Giriniz!");
    }
           ...
           axios.get("roles/rolelist").then((resRole) => {
              for (var i = 0; i < resRole.data.length; i++) {
                ...
                if(tokenRoleName==resRole.data[i].roleName)
                {
                  ...
                  if (this.state.isCheckedCompanyEdit == false) {
                    this.setState({
                      showStatus: true,
                    });
                  }
                        ...
                        <div className="col-md-6">
                          <div className="card card-danger">
                            <div className="card-header">
                              <h3 className="card-title">Firma Güncelle</h3>
                            </div>
